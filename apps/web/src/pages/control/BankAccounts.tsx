...
import { Bank, Plus, PencilSimple, Power, X } from '@phosphor-icons/react';
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-slate-500">{account.bankName} · ****{account.lastFourDigits}</p>
                      </div>
                    </div>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <h3 className="text-lg font-bold text-slate-900">{editing ? 'Editar Cuenta' : 'Nueva Cuenta Bancaria'}</h3>
